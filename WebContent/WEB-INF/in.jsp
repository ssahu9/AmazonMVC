	...
	<div class="container">
		...
		<! [endif] -->
					...
					<div class="registration_form">
						<!-- Form -->
						<form:form id="registration_form" action="./register" modelAttribute="customer" method="post">
							<div>
								<label> <form:input placeholder="first name:" type="text" 
								pattern="^[a-zA-Z]{1,20}$" tabindex="1"  required="" autofocus="" path="firstName"/>
								</label>
								<%-- <form:errors path="firstName" /> --%>
							</div>
							<div>
								<label> <form:input placeholder="last name:" type="text" 
								pattern="^[a-zA-Z]{1,20}$" tabindex="1"  required="" autofocus="" path="lastName"/>
								</label>								
								<%-- <form:errors path="lastName" /> --%>
							</div>
							<div>
								<label> <form:input placeholder="email address:" type="email"
									name="email" tabindex="3" path="email" required=""/>
								</label>
								<%-- <form:errors path="email" /> --%>
							</div>
							<div>
								<label> <form:input placeholder="number" type="tel"
									 pattern="^[7-9][0-9]{9}$" tabindex="3" path="phoneNumber" required=""/>
								</label>
								<%-- <form:errors path="phoneNumber" /> --%>
							</div>
						
							<div>
								<label> <form:input placeholder="password" type="password"
							...
							<div>
								<form:button type="submit" value="create an account"
									id="register-submit"/>
							</div>
						</form:form>
						<!-- /Form -->
				...
				<div class="registration_left">
					...
					<div class="registration_form">
						<!-- Form -->
						<form:form id="registration_form" modelAttribute="user" action="/login" method="post">
							<div>
								<label> <form:input placeholder="email:" name="email"
									type="email" tabindex="3" path="email" required=""/>
								</label>
							</div>
							<div>
								<label> <form:password placeholder="password" path="password" name="password"
